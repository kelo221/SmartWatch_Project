...
func (uu *UserUpdate) SetElevated(b bool) *UserUpdate {
	uu.mutation.SetElevated(b)
	return uu
}

// SetNillableElevated sets the "elevated" field if the given value is not nil.
func (uu *UserUpdate) SetNillableElevated(b *bool) *UserUpdate {
	if b != nil {
		uu.SetElevated(*b)
	}
	return uu
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Elevated(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
...
// SetElevated sets the "elevated" field.
func (uuo *UserUpdateOne) SetElevated(b bool) *UserUpdateOne {
	uuo.mutation.SetElevated(b)
	return uuo
}

// SetNillableElevated sets the "elevated" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableElevated(b *bool) *UserUpdateOne {
	if b != nil {
		uuo.SetElevated(*b)
	}
	return uuo
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Elevated(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: user.FieldElevated,
