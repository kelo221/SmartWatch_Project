...
func (uc *UserCreate) SetElevated(b bool) *UserCreate {
	uc.mutation.SetElevated(b)
	return uc
}

// SetNillableElevated sets the "elevated" field if the given value is not nil.
func (uc *UserCreate) SetNillableElevated(b *bool) *UserCreate {
	if b != nil {
		uc.SetElevated(*b)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.Elevated(); !ok {
		v := user.DefaultElevated
		uc.mutation.SetElevated(v)
	}
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.Elevated(); !ok {
		return &ValidationError{Name: "elevated", err: errors.New(`ent: missing required field "User.elevated"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Elevated(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: user.FieldElevated,
		})
		_node.Elevated = value
	}
